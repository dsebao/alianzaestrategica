<!-- Topbar Search -->
<form id="mainsearch" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" action="<?php bloginfo('url'); ?>/dashboard/busqueda/">
    <!-- <div class="input-group">
        <input type="text" class="form-control bg-light border-0 small" placeholder="Buscar empresa, producto o servicio..." aria-label="Search" aria-describedby="basic-addon2">
...
<ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown no-arrow">
        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $theuser->display_name; ?></span>
            <img class="img-profile rounded-circle" src="<?php echo get_the_avatar_url(get_avatar($theuser->ID, 70, '', '', array('scheme' => 'https'))); ?>">
        </a>
