		...
		<div class="auth-container-right p-3 p-md-5">
			...
			<?php if ($state == 'recover') { ?>
				...
				<form class="user needs-validation js-ajaxform" method="post" novalidate>
					...
					<div class="form-group">
						<input type="email" name="email" class="form-control form-control-user" id="email" aria-describedby="email" placeholder="Ingresa tu email" required>
			...
			<?php } elseif ($state == 'resetpass' && isset($userreset)) { ?>
				...
				<form class="user needs-validation js-ajaxform" method="post" novalidate>
					...
					<div class="form-group">
						<input type="password" name="pass" class="form-control form-control-user" id="pass" placeholder="Nueva Contraseña" required>
			...
			<?php } else { ?>
				...
				<form class="user needs-validation js-ajaxform" method="post" novalidate>
					...
					<div class="form-group">
						<input type="email" name="email" class="form-control form-control-user" id="email" aria-describedby="email" placeholder="Email" required>
						<div class="invalid-feedback">Ingresa un email válido</div>
					</div>

					<div class="form-group">
						<input type="password" name="pass" class="form-control form-control-user" id="pass" placeholder="Contraseña" required>
